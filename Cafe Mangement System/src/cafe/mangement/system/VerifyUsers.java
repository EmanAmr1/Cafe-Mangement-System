...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    {
        dtm.addRow(new object[]{userObj.getId(),userObj.getName(),userObj.getEmail(),userObj.getMobileNmber(),userObj.getAddress(),userObj.getSecurityQestion(),userObj.getStatus()});
    }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 127, 1346, 510));
    ...
    private void txtEmailKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEmailKeyReleased
        ...
        getAllRecords(email);        // TODO add your handling code here:
